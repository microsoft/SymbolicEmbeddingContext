...
class CSharpDataset(BaseDataset):
    ...
    def get_instance_and_setup_env(self, i: int) -> TaskData:
        working_repo_dir = f"{self.working_repo_dir}{i}"
        ...
        working_repo_path = os.path.join(
            working_repo_dir, data_instance["repo_metadata"]["repo_name"]
        )
        ...
        ground_truth_path = os.path.join(working_repo_path, data_instance["file"])
        ...
        return TaskData(
            ...
            # ),
            evaluator=None,
            repo_dir=f"temp/csharp/working_repo{i}/"
            + data_instance["repo_metadata"]["repo_name"],
            repo_metadata=data_instance["repo_metadata"],
            ground_truth=ground_truth,
            test_file=None,
            test_class_name=None,
            evaluation_metadata=data_instance["evaluation_metadata"],
        )
